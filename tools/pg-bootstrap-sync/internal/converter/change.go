...
// GetNextLSN returns the next LSN that would be generated
func (c *ChangeConverter) GetNextLSN() string {
	return c.lsnGenerator.Peek()
}

// GetCurrentSequence returns the current sequence number
func (c *ChangeConverter) GetCurrentSequence() int64 {
	return c.lsnGenerator.GetSequence()
}