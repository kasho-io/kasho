...
```
ghcr.io/jeffrey/kasho:latest
```

### Image Tags

- **`:latest`** - The most recent stable release
- **`:v1.0.0`** - Specific version releases (recommended for production)
...
docker pull ghcr.io/jeffrey/kasho:latest

# Pull a specific version
docker pull ghcr.io/jeffrey/kasho:v1.0.0

# Pull the development version
docker pull ghcr.io/jeffrey/kasho:develop
```
