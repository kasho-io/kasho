...
2. **licensing** - Validates and manages Kasho licenses
3. **pg-change-stream** - Captures changes from your source PostgreSQL database
4. **pg-translicator** - Applies transformations and writes to your target database
