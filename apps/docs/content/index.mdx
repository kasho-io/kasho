...
### 📦 Simple Deployment
Deploy with Docker using a single image containing all components. Available from GitHub Container Registry at `ghcr.io/kasho-io/kasho`. Works with Kubernetes, ECS, or any container orchestration platform.
