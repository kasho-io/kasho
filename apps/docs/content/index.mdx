...
### 📦 Simple Deployment
Deploy with Docker using a single image containing all components. Available from GitHub Container Registry at `ghcr.io/jeffrey/kasho`. Works with Kubernetes, ECS, or any container orchestration platform.
